...
{
<<<<<<< Updated upstream
    //Sorry IDG, but im gonna have to "Steal" the code to port it. Also special thanks to Boffin for the shader. (the rest of the code is IDG's) - Hatred
    public class TrailHelper
    {
        ...
        {
            DrawTrail(drawPoses.Select(testby => testby.ToVector3()).ToList(), default);
        }
        ...
        public void DrawTrail(List<Vector3> drawPoses, Vector2 defaultloc = default)
        {
            ...
            for (k = 1; k < totalcount; k++)
            {
                ...
                //You want prims, you get prims! (what)
            ...
            repeater:
                ...
                Color colortemp2 = Color.Lerp(valuecol2, valuecol2 * fadeTo, fraction);
