...
{
	public class RangedThrowing : DamageClass
	{
		public static RangedThrowing Instance;
		...
		public override void SetDefaultStats(Player player)
		{
			...
			//player.GetCritChance<RangedThrowing>() += player.GetCritChance<GenericDamageClass>() + player.GetCritChance<RangedDamageClass>() + player.GetCritChance<ThrowingDamageClass>();
			//Main.NewText("player.GetCritChance<RangedDamageClass>() " + player.GetCritChance<GenericDamageClass>());
